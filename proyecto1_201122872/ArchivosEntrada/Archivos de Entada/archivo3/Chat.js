...
funcion CambioGrupo(numero, boton){
	si(numero <= 10 && boton <= 10){
		Documento.Obtener("usuario" + boton ). setElemento ("grupo", "boton_val" + numero);
	}
	sino{
		Documento.Obtener("mensaje" + boton ). setElemento ("grupo", "boton_val" + numero);	
	}

	dimv ruta_imagen : "C:/proyecto1/avatar/";
	seleciona(numero){
		case 1:
