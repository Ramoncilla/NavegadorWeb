...
Dimv boton_cambio;
Documento.Observador("listo", far2());

funcion far2(){ 
	Imprimir("================= Documento Cargo Completo ===================="); 
	boton_cambio : Documento.Obtener("boton_cambio");
	boton_cambio.Observador("cliqueado", cambio_recursivo());
}
...
Documento.Observador("listo", far1());

 funcion far1(){ 
	Imprimir("================= Documento Cargo Completo ===================="); 

	boton_val6 : Documento.Obtener("boton_operacion_5");
	boton_val6.Observador("cliqueado", Boton_5());

	boton_val6 : Documento.Obtener("boton_operacion_6");
	boton_val6.Observador("cliqueado", Boton_6());
	
	boton_val7 : Documento.Obtener("boton_operacion_7");
	boton_val7.Observador("cliqueado", Boton_7());
	
	boton_val8 : Documento.Obtener("boton_operacion_8");
	boton_val8.Observador("cliqueado", Boton_8());

	
	boton_val9 : Documento.Obtener("boton_operacion_9");
	boton_val9.Observador("cliqueado", Boton_9());
	
	boton_val10 : Documento.Obtener("boton_operacion_10");
	boton_val10.Observador("cliqueado", Boton_10());
	
	boton_val11 : Documento.Obtener("boton_operacion_11");
	boton_val11.Observador("cliqueado", Boton_11());
	
	boton_val12 : Documento.Obtener("boton_operacion_12");
	boton_val12.Observador("cliqueado", Boton_12());

	
	boton_val13 : Documento.Obtener("boton_operacion_13");
	boton_val13.Observador("cliqueado", Boton_13());
	
	boton_val14 : Documento.Obtener("boton_operacion_14");
	boton_val14.Observador("cliqueado", Boton_14());
	
	boton_val15 : Documento.Obtener("boton_operacion_15");
	boton_val15.Observador("cliqueado", Boton_15());
	
	boton_val16 : Documento.Obtener("boton_operacion_16");
	boton_val16.Observador("cliqueado", Boton_16());
